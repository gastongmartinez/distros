...
./tweaks.sh -f
sudo ./tweaks.sh -g -b "/usr/share/backgrounds/Landscapes/landscapes 01.jpg"
cd ..
...
dconf write /org/gnome/shell/extensions/arcmenu/menu-button-color "'rgb(38,162,105)'"
