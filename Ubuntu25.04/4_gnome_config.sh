...
############################################## Extensiones ##################################################################################
# Activar extensiones
dconf write /org/gnome/shell/enabled-extensions "['ubuntu-appindicators@ubuntu.com', 'arcmenu@arcmenu.com', 'widgets@aylur', 'blur-my-shell@aunetx', 'caffeine@patapon.info', 'dash-to-dock@micxgx.gmail.com', 'no-overview@fthx', 'systemd-manager@hardpixel.eu', 'tiling-assistant@leleat-on-github', 'Vitals@CoreCoding.com', 'user-theme@gnome-shell-extensions.gcampax.github.com', 'drive-menu@gnome-shell-extensions.gcampax.github.com']"
dconf write /org/gnome/shell/disabled-extensions "['ding@rastersoft.com', 'ubuntu-dock@ubuntu.com', 'ubuntu-appindicators@ubuntu.com']"
